...
public class ExpressionMessageFilter implements MessageFilter {
    ...
    public boolean isMatchedByConsumeQueue(Long tagsCode, ConsumeQueueExt.CqExtUnit cqExtUnit) {
        ...
        // by tags code.
        // 基于 TAG 模式，根据 ConsumeQueue 进行消息过滤时只对比 tag 的 hashcode，所以基于 TAG 模式消息过滤，还需要在消息消费端对消息 tag 进行精确匹配
        // 如果是 TAG 过滤模式，并且消息的 tagsCode 为空或 tagsCode 小于 0，返回 true，说明消息在发送时没有设置 tag。
